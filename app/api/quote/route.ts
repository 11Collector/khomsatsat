...
// 💡 ปรับ Prompt ใหม่: สั่งเด็ดขาดห้ามมีเครื่องหมาย " " และเอาทางเลือกที่ทำให้ AI สับสนออก
    const prompt = `
      ...
      ตัวอย่างการจัดหน้าและตัดบรรทัดที่ถูกต้อง (สั้น กระชับ 4 บรรทัด เนียนเป็นเนื้อเดียวกัน):
      ความล้มเหลวในวันนี้
