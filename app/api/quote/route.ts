...
export async function POST(req: Request) {
 ...
 // 💡 ปรับ Prompt ใหม่: เน้นความสั้น กระชับ และเปลี่ยนตัวอย่างให้ไม่เกิน 5 บรรทัด
    const prompt = `
      ...
      1. ต้องลึกซึ้ง กระแทกใจ ให้ข้อคิดสะกิดใจแบบเฉียบขาด ไม่ต้องมี "" ในคำคมนั้น
      2. ความยาวรวมต้องสั้นมากๆ (ห้ามเกิน 30-35 คำรวมทั้งบท) ทรงพลัง ไม่เยิ่นเย้อ
      3. ต้องขึ้นบรรทัดใหม่ (\\n) ตามจังหวะการอ่าน บรรทัดละประมาณ 3-5 คำ ถ้ามันดูตัดยากเอา "" ออกจากคำนั้นก็ได้
      4. **ห้ามแต่งเกิน 7 บรรทัดเด็ดขาด**
